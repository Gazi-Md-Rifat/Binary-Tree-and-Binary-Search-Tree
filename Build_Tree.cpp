...
// Build Tree using Inorder and Preorde sequence....
...
Tree *Build_Tree(int preorder[], int inorder[], int start, int end)
{
	static int idx = 0;
	if (start > end)
	{
	...
	int pos = search_position(inorder, start, end, current);
